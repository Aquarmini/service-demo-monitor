...
class RegisterProcessor {
  ...
  protected function process_version($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\Xin\Thrift\Register\Register_version_args', $input->isStrictRead());
    }
    else
    {
  ...
  protected function process_heartbeat($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\Xin\Thrift\Register\Register_heartbeat_args', $input->isStrictRead());
    }
    else
    {
