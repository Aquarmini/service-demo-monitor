...
class BaiduProcessor {
  ...
  protected function process_tiebaSign($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\Xin\Thrift\MonitorService\Baidu_tiebaSign_args', $input->isStrictRead());
    }
    else
    {
  ...
  protected function process_myTiebas($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\Xin\Thrift\MonitorService\Baidu_myTiebas_args', $input->isStrictRead());
    }
    else
    {
  ...
  protected function process_tieba($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\Xin\Thrift\MonitorService\Baidu_tieba_args', $input->isStrictRead());
    }
    else
    {
  ...
  protected function process_tiebaList($seqid, $input, $output) {
    ...
    if ($bin_accel)
    {
      $args = thrift_protocol_read_binary_after_message_begin($input, '\Xin\Thrift\MonitorService\Baidu_tiebaList_args', $input->isStrictRead());
    }
    else
    {
