...
class BaiduClient implements \Xin\Thrift\MonitorService\BaiduIf {
  ...
  {
    $this->send_tiebaList($nickName);
    return $this->recv_tiebaList();
  }

  public function send_tiebaList($nickName)
  {
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'tiebaList', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('tiebaList', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_tiebaList()
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Xin\Thrift\MonitorService\Baidu_tiebaList_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
