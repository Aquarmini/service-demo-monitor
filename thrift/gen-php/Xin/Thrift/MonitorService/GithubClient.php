...
class GithubClient implements \Xin\Thrift\MonitorService\GithubIf {
  ...
  {
    $this->send_release($owner, $repo);
    return $this->recv_release();
  }

  public function send_release($owner, $repo)
  {
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'release', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('release', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_release()
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Xin\Thrift\MonitorService\Github_release_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
    ...
    throw new \Exception("release failed: unknown result");
  }
